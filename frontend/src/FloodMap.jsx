...
function generateDynamicZones(
  ...
  const globalRisk =
    ...
    ((100 - drainage) / 100) * 0.3 +

    ((100 - elevation) / 100) * 0.2;
 ...
 onZoneClick
  ...
  useEffect(() => {
    ...
    const initMap = () => {
      ...
      const baseData= CITY_ZONES[city];

const data={

 ...baseData,

 zones:generateDynamicZones(
